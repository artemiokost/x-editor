            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_DropdownItem2.default, {
                    ...
                    onClick: function onClick() {
                        return _this.onChange(item.key);
                    }
                })
            );
        };

        _this.preventSelection = function (event) {
    ...
    _createClass(Dropdown, [{
        ...
        value: function render() {
            ...
            var selectedItem = this.props.items.filter(function (obj) {
                return obj.key === _this2.props.selected;
            })[0];

            var isOpen = this.state.isOpen;


            var arrowClassName = (0, _classnames2.default)("dropdown__arrow", { "dropdown__arrow--open": isOpen });
            var dropdownClassName = (0, _classnames2.default)("dropdown", { "dropdown--open": isOpen });
            var wrapperClassName = (0, _classnames2.default)("dropdown__wrapper", { "dropdown__wrapper--open": isOpen });
