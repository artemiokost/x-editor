...
var VideoButton = function (_Component) {
    ...
    function VideoButton() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = VideoButton.__proto__ || Object.getPrototypeOf(VideoButton)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function (e) {
            e.preventDefault();
            ...
            var data = { src: src, type: _constants.MEDIA_TYPE_VIDEO };
