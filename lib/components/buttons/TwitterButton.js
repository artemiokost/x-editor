...
var TwitterButton = function (_Component) {
    ...
    function TwitterButton() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TwitterButton.__proto__ || Object.getPrototypeOf(TwitterButton)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function (e) {
            e.preventDefault();
            var tweetId = window.prompt(_this.props.i18n["Enter a Tweet ID"]);
            if (!tweetId) {
                return;
            }

            var data = { tweetId: tweetId, type: _constants.MEDIA_TYPE_TWITTER };
